...
**NY Times Reader** is an android app that allows a user to search for images on web using simple filters. The app utilizes [New York Times Search API](http://developer.nytimes.com/docs/read/article_search_api_v2).
...
* [x] Filter icon in action bar changes color if any filters are applied to search queries.
...
<img src='https://raw.githubusercontent.com/adilansari/nytimes-reader/master/screengrabs/video_demo.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
